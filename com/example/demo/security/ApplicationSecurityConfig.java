...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
	 ...
	 * User.builder().email("kerang@ka.el").password(passwordencoder.encode("password")).
	 * roles("ADMIN").build(); UserDetails
	 * usertwo=User.builder().email("test").password(passwordencoder.encode(
